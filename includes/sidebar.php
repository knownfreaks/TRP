...
<div class="d-flex">
    <nav id="sidebar" class="navbar navbar-dark bg-dark flex-column align-items-stretch p-3 sidebar" style="min-height:100vh;width:220px;">
        ...
        <ul class="navbar-nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="index.php?page=inventory"><i class="fas fa-box me-2"></i>Inventory</a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link text-white" href="index.php?page=customers"><i class="fas fa-users me-2"></i>Customers</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="index.php?page=finance"><i class="fas fa-money-bill-wave me-2"></i>Finance</a>
            </li>
            <?php endif; ?>
